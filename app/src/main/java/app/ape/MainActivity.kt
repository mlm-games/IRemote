...
import app.ape.ui.EditRemoteScreen
import app.ape.ir.ui.RemoteListScreen
import app.ape.ir.ui.RemoteScreen
import app.ape.ir.viewmodel.RemoteListViewModel
import app.ape.ir.viewmodel.RemoteViewModel
import app.ape.ui.screens.SettingsScreen
import app.ape.ui.theme.ApeTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            ApeTheme(darkTheme = dark, useAuroraTheme = settings.useAuroraTheme) {
